package _01_01_what_are_abstractions.begin;
...
Include a discussion that we refactor to
abstractions, we don't need to plan abstractions
in advance. Create the code we need, make sure
it works, then refactor it to an appropriate
abstraction layer. Abstractions are a decision
making process, there are no rights and wrongs,
until we apply them to specific contexts, some
teams will standardise on one approach, some on
others, we need to understand the different
